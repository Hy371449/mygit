...
def _get_ref_internal(ref, deref):
    """
        When given a non-symbolic ref, return the ref name and value.
        When given a symbolic ref, dereference the ref recursively, and then return the name of the last (non-symbolic) ref that points to an OID, plus its value.
    """
    ref_path = f'{GIT_DIR}/{ref}'
    value = None
